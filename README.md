# Hardware store made with Commerce.js and Next.js 🛍️💳

[![Netlify Status](https://img.shields.io/netlify/157bb2e2-611e-4bbd-9a59-c876f8c3c58a?style=for-the-badge)](https://app.netlify.com/sites/massi105/deploys)

[Massi105](https://massi105.it) is an hardware eCommerce store built using the [Commerce.js](https://commercejs.com/) SDK and [Next.js](https://nextjs.org) with live deployment to Netlify.

[![Chec see live demo button](https://cdn.chec.io/email/assets/marketing/chec-demo-btn.svg)](https://massi105.it)
...
When prompted to choose a store from the list, choose "commercejs-nextjs-demo-store". This command will also
...
This store uses a range of features provided by Commerce.js and powered by the Chec Dashboard.
...
Commerce.js provides many tools to streamline checkout implementations. The checkout in this store makes use of:
...
Commerce.js provides inbuilt functionality for supporting customer logins without any server side code. This store
...
This store is configured with the Chec "test gateway" out of the box, which provides a handy payment option while
...
Paypal and manual gateways have also been enabled.
