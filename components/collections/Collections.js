                  ...
                  <a className="mb-5 font-color-black">
                    <div className="d-flex">
                      <p className="mb-2 position-relative cursor-pointer">
                        {/* Products */}
                        <span className="font-size-title font-weight-medium mb-3">
                          {category.name}
                        </span>
                        <span
  ...
  renderCollection() {
    ...
    return (
      <div className="collection">
        {categories.map(category => (
          <div key={category.id}>
              <p className="font-size-heading font-weight-bold mb-4" id={category.slug}>
                {category.name}
              </p>
...
export default connect(state => state)(withTranslation()(Collections));
