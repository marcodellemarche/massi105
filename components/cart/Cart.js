              ...
              <div className="px-4 px-md-5">
                <div className="pt-4 pb-3 borderbottom border-color-black d-flex justify-content-between align-items-center">
                  ...
                  <button
                    ...
                    onClick={() => toggle(false)}
                  >
                    <svg className="fill-black w-32 h-32">
                    ...
                    <div className="row">
                      ...
                      <div className="col-12 col-md-6">
                        <Link href="/checkout">
                          <a 
                            onClick={() => toggle(false)}
                            className="h-56 d-flex align-items-center justify-content-center bg-brand700 w-100 flex-grow-1 font-weight-medium font-color-white px-3">
                            {t('cart.checkout')}
                          </a>
                        </Link>
                      </div>
                ...
                <div className="d-flex align-items-center justify-content-center bg-brand300 flex-grow-1 p-4 p-md-5 flex-column">
                  <div className="position-relative cursor-pointer mb-3">
                    <svg className="fill-black w-32 h-32">
                      ...
                      <use xlinkHref="/icons.svg#cart"></use>
                    </svg>
                    <div
